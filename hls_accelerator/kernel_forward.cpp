...
// ══════════════════════════════════════════════════════════
// Board-Specific Configuration: ZCU104-02 (1.7 GB RAM)
// ══════════════════════════════════════════════════════════
#define BUF_A_PHYS   0x50000000ULL  // Buf A: 50000000 -> 53300000
#define BUF_BD_PHYS  0x53300000ULL  // Buf Bd: 53300000 -> 56600000
#define BUF_BQS_PHYS 0x56600000ULL  // Buf Bqs: 56600000 -> 59900000
#define BUF_C_PHYS   0x59900000ULL  // Buf C: 59900000 -> 5CC00000
#define BUF_SIZE     0x4000000      // 64MB reserved map size

#define FPGA_MAX_K   6144
#define FPGA_MAX_N   6144
...
int fpga_init(void) {
    ...
    LOGI("Configured for Board ZCU104-02 (1.7GB): max K=%ld N=%ld", g_fpga_max_k, g_fpga_max_n);
